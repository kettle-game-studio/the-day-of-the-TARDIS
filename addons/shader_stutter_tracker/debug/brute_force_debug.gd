...
var _triggers_collector: CurrentNodeTriggerCollectorService
...
func _ready() -> void:
	...
	_triggers_collector = CurrentNodeTriggerCollectorService.new(self)
...
class CurrentNodeTriggerCollectorService:
